...
module.exports = {
  name: 'give-item',
  aliases: ['giveitem'],
  description: 'إهداء منتج لعضو | -give-item [@المستخدم] [اسم المنتج]',
  ...
  async execute(message, args, client) {
    ...
    if (args.length < 2) {
      return message.reply('الاستخدام الصحيح: `-give-item [@المستخدم] [اسم المنتج]`\nمثال: `-give-item @user VIP Role`');
    }
    ...
    // Send DM invoice
    const dm = invoiceEmbed('item_given', {
      itemName: item.name,
